...
namespace Klinspot.Areas.Control.Controllers
{
    public class BlogsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Title,Slug,Date,Photo,Text")] Blog blog)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Title,Slug,Date,Photo,Text")] Blog blog)
        {
            if (ModelState.IsValid)
            {
